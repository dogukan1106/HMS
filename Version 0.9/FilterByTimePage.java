...
public class FilterByTimePage {
    ...
    public void initialize() {
        frame = new JFrame("Filter Appointments By Time");
        ...
        makeApp.setForeground(Color.black);
        makeApp.setBackground(Color.white);
        makeApp.setBounds(200,190,100,50);
        frame.add(makeApp);
        ...
        doctorList.setBounds(200,40,150,150);
        ...
        makeApp.addActionListener(new MakeAppButtonListener(doctorList,frame,model,time_slots,date_slots));
