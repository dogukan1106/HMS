...
public class DoctorViewAppPage {
    ...
    public void initialize() {
        ...
        back_button.addActionListener(new backToDoctorPageListener(frame));
        ...
        cancelApp.setBounds(330,60,150,75);
        cancelApp.addActionListener(new AdminCancelAppButtonListener(frame,appList,model));
        cancelApp.setBackground(Color.RED);
        cancelApp.setForeground(Color.white);
        frame.add(cancelApp);
